...
{{
  "issues": [
    {{
      ...
      "problem": "<суть проблемы одним предложением>",
      "fix": "<что сделать, одним предложением>"
    }}
  ],
